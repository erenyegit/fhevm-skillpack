...
# The current demo (ConfidentialGroupBuy) is deployed via `forge create` directly;
# see demo/setup-checklist.md for the live-on-Sepolia flow.
#
...
echo "scripts/chain.sh is deprecated. See demo/setup-checklist.md and"
